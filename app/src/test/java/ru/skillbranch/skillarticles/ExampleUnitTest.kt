...
class ExampleUnitTest {
    ...
    fun test_group_by_bounds() {
        ...
        val bounds = mutableListOf(0 to 10, 10 to 30, 30 to 50, 50 to 60, 60 to 100)
        val expectedList = mutableListOf(
            mutableListOf(2 to 5, 8 to 10),
            mutableListOf(10 to 20, 22 to 30),
            mutableListOf(45 to 50),
            mutableListOf(),
            mutableListOf(70 to 100)
        )
        assertEquals(expectedList, listResult.groupByBounds(bounds))
    }
//    @Test
//    fun parse_list_item() {
